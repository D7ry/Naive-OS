...
/*Project 4 stuff*/
unsigned long long block_get_read_cnt(struct block* a_block) {
  return a_block->read_cnt;
}

unsigned long long block_get_write_cnt(struct block* a_block) {
  return a_block->write_cnt;
}