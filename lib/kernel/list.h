 ...
 *                  to implement this function, first obtain the the struct which list_elem is embedded in using LIST_ENTRY,
 *                  then free all the struct's members, and finally free the struct itself.
 */
 ...
 *                  then free all the struct's members, and finally free the struct itself.
 */
void list_free(struct list* list, void (*free_func)(struct list_elem* e));
